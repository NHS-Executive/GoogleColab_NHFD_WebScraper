...
- `GoogleColab_NHFD_WebScraper.ipynb`: legacy webscraper, it downloads data files divided by site. You can currently upload these files in the relevant buckets of the project:
...
- `V2_GoogleColab_NHFD_WebScraper.ipynb`: new version of the webscraper. It downloads all data for all sites in 4 distinct files (denoms, LOS, KPI and OP). You can upload these files in the new bucket for the project (currently, UAT version only): [`nhsexec-nhfd-uat`]() (add link!)
